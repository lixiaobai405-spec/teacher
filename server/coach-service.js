...
const FACT_RETRY_GUIDANCE = Object.freeze({
  ...
  [FACT_BOUNDARY_CODES.UNSUPPORTED_NUMBER]: '删除事实源中不存在且未明确标注为建议或未来行动的具体数字、比例或数量。frequency 及明确的未来建议可以新增次数或时长，但不得将新增数字写成员工现状、既成结果或事实依据；比例、人数、金额、分数、事项数量和对象数量仍须有事实来源。',
