...
步骤 3 的有限例外：frequency 以及明确标注为“建议”“可以”“可考虑”“下一步”“后续”“未来”“计划”或 Will（行动承诺）的未来行动，可以新增次数或时长。所有新增数字不得写成员工现状、既成结果或事实依据；比例、人数、金额、分数、事项数量和对象数量仍必须有事实来源。首次生成和重新生成遵守相同边界。
